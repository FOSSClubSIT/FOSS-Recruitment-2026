...
**[Live Site](https://yashchandnani07.github.io)**
...
Visit [/terminal.html](https://yashchandnani07.github.io/terminal.html) for an interactive terminal-style resume.
...
### Challenges
- **Building without frameworks:** Implementing complex interactions like the book-flip animation and the terminal's split-pane logic using vanilla JavaScript required careful state management and DOM manipulation that a framework like React would have handled more abstractly.
- **Scroll Performance:** Ensuring the animated scroll highlights and SVG parallax effects remained smooth across different devices required optimizing event listeners and using CSS transforms where possible.

### What I'd do differently
- **Accessibility:** While the design is bold and experimental, I would spend more time ensuring it meets higher accessibility standards, particularly for screen readers and keyboard navigation in the terminal mode.
- **CSS Architecture:** The CSS for the neo-brutalist theme grew quite large; in a future iteration, I might use a CSS preprocessor like SCSS to better organize the variables and mixins.
